...
//supplying and accepting of values and type must be in corresponding order.
//int downcasting to byte, int downcasting to short.. because even if it falls under the range of byte by default it will assign to int so we have to downcast.
